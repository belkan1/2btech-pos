                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4 col-sm-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" placeholder="Search by name"  aria-describedby="basic-addon1" v-model="search" @keyup="searchData">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="alert alert-danger" v-if="errors != ''" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="add.kota" class="form-control" placeholder="City">
                                </div>
                                <div class="form-group">
                    ...
                    <form action="" method='POST' enctype="multipart/form-data" @submit.prevent="userUpdate(edit.id)">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" class="form-control" v-model="edit.address"></textarea>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="example-search-input" class="col-sm-4 col-form-label">Customer Name: </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="example-search-input" class="col-sm-4 col-form-label">Mobile Number: </label>
                            <div class="col-sm-8">
...
export default {
    ...
    methods: {  
        ...
        userDetail(id) {
            axios.get(`/api/v1/customer/${id}`)
                .then(res => {
                    ...
                    this.detail.address = res.data.alamat;
                    this.detail.level = res.data.role;
        ...
        userDelete(id) {
            let that = this;
            alertify.confirm("Are you sure you want to delete user?", function (ev) {
                ev.preventDefault();
        ...
        userEdit(id) {
            axios.get(`/api/v1/customer/${id}/edit`)
                .then(res => {
                    ...
                    this.edit.address = res.data.alamat;
                    this.edit.level = res.data.role;
        ...
        userUpdate(id) {
            ...
            formData.append('alamat', this.edit.address);
            ...
            axios.post(`/api/v1/customer/${this.edit.id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    ...
                    this.displayData();
                        Swal.fire(
                        `Success!`,
                        `User Data Successfully changes ${this.add.level}!`,
                        'success'
                        )
        ...
        customerAdd() {
            ...
            axios.post('/api/v1/customer', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    ...
                    let statusCode = error.response.status;
                    if(statusCode == 500) {
                        this.errors = {"error": "Server is down."};
                    }else if(statusCode == 400) {
                        console.log(error.response.data)
                        this.errors = error.response.data;
                    }
