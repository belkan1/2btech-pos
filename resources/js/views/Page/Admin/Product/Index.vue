                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4 col-sm-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" placeholder="Search by category name" aria-label="Cari Nama Kategori" aria-describedby="basic-addon1" v-model="search" @keyup="searchData">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="stock" type="number" class="form-control"
                                        name="stock" placeholder="Stock Amount" v-model="add.stock">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="ppn" type="number" class="form-control"
                                        name="ppn" placeholder="VAT(in %)" v-model="add.ppn" >
                                </div>
                                <div class="form-group">
                    ...
                    <form action="" method='POST' enctype="multipart/form-data" @submit.prevent="updateProduct(edit.id)">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="email">VAT</label>
                                <input id="price" type="number" class="form-control"
                                    name="ppn" placeholder="amount" v-model="edit.ppn" >
                            </div>
                            <div class="form-group">
                                <label for="">Image</label>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="inputGroupFile01">Your image</label>
                                    </div> 
                                </div>
                            </div>
                        </div>
        ...
        addProduct() {
            ...
            axios.post('/api/v1/product', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    ...
                    Swal.fire(
                        `Success!`,
                        `Product ${this.add.name} Added Successfully!`,
                        'success'
                    )
                    this.add.name = '';
        ...
        updateProduct(id) {
            ...
            axios.post(`/api/v1/product/${id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    ...
                    Swal.fire(
                        `Success!`,
                        `Product ${this.edit.name} Edited Successfully!`,
                        'success'
                    )
                    this.edit.name = '';
