            ...
            <div class="col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-8">
                                <h4 class="mt-0 header-title">All Suppliers</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4 col-sm-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" placeholder="Search Supplier By Name/Email"  aria-describedby="basic-addon1" v-model="search" @keyup="searchData">
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover table-lg" id='category-table'>
                                ...
                                <tbody>
                                    <tr v-for="data in suppliers" v-bind:key='data.id'>
                                        <td>{{ data.id }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class='btn btn-warning' @click="supplierEdit(data.id)">Edit</button>
                                            <button type="button" @click="supplierDelete(data.id)" class="btn btn-danger">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="" method='POST' enctype="multipart/form-data" @submit.prevent="supplierAdd()">
                        <div class="modal-body">
                            <div class="alert alert-danger" v-if="errors != ''" >
                                ...
                                <div class="form-group">
                                    <label for="">Mob: </label>
                                    <input type='text' name="description" class="form-control" v-model="add.mobile">
                                </div>
                                <div class="form-group">
        ...
        <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="" method='POST' enctype="multipart/form-data" @submit.prevent="supplierUpdate(edit.id)">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type='text' name="description" class="form-control" v-model="edit.mobile">
                                </div>
                                
                                <div class="form-group">
                                    <label for="">Image: </label>
                                    <input type="file" name="file" id="" class='form-control-file' accept='image/*' @change="onChangePhotoEdit">
                                    <img :src="`/images/suppliers/${edit.image_name}`" alt="" class="image-table" id='edit-category-image'>
                                </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control-plaintext" type="search" id="example-search-input" v-model="detail.mobile" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
export default {
    ...
    methods: {  
        displayData(page = 1, search= '') {
            axios.get('/api/v1/suppliers', { params: { search: this.search, page: this.page } })
                .then(result => {
        ...
        supplierDelete(id) {
            ...
            alertify.confirm("Are you sure?", function (ev) {
                ev.preventDefault();
                axios.get(`/api/v1/supplier/delete/${id}`)
                    .then(res => {
                        console.log(res);
                        that.displayData();
        ...
        supplierEdit(id) {
            axios.get(`/api/v1/supplier/edit/${id}`)
                .then(res => {
                    ...
                    this.edit.mobile = res.data.mobile;
        ...
        supplierUpdate(id) {
            ...
            formData.append('mobile', this.edit.mobile);
            ...
            axios.post(`/api/v1/supplier/update/${this.edit.id}`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    $('#modalEdit').modal('toggle');
                    this.displayData();
                        Swal.fire(
                        `Success!`,
                        `Supplier Updated Successfully ${this.edit.name}!`,
                        'success'
                        )
        ...
        supplierAdd() {
            ...
            formData.append('mobile', this.add.mobile);
            formData.append('photo', this.add.photo);

            axios.post('/api/v1/supplier/create', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then(res => {
                    console.log(res);
                    ...
                    setTimeout(() => {
                        Swal.fire(
                        `Success!`,
                        `Supplier Added Successfully ${this.add.name}!`,
                        'success'
                        )
                    }, 200);
