        ...
        <div class="row">
                ...
                <div class="card bg-info mini-stat text-white">
                    <div class="p-3 mini-stat-desc">
                        <div class="clearfix">
                            ...
                            <h4 class="mb-3 mt-0 float-right">Rs {{ numberFormat(data.pendapatan_bulan_ini) }}</h4>
                        </div>
                        <div>
                    ...
                    <div class="p-3">
                        ...
                        <p class="font-14 m-0">Last Month : Rs {{numberFormat(data.pendapatan_bulan_lalu)}}</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card bg-pink mini-stat text-white">
                    <div class="p-3 mini-stat-desc">
                        <div class="clearfix">
                            ...
                            <h4 class="mb-3 mt-0 float-right">Rs {{ numberFormat(data.average_price) }}</h4>
                        </div>
                        <div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success mini-stat text-white">
                    <div class="p-3 mini-stat-desc">
                        <div class="clearfix">
                            <h6 class="text-uppercase mt-0 float-left text-white-50">Products For Sale</h6>
