                        ...
                        <div class="row">
                            <div class="offset-md-8 col-md-4 col-sm-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" placeholder="Search Category Name" aria-label="Cari Nama Kategori" aria-describedby="basic-addon1" v-model="search" @keyup="searchData">
                                </div>
                            </div>
                        </div>
        ...
        deleteCategory(id) {
            ...
            axios.delete(`/api/v1/category/${id}`)
                .then(function() {
                    ...
                    Swal.fire('Success Deleting Category!','Success!','success');
                    _this.displayData();
                });
        },
