                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="td-30">Total Product Category: </td>
                                        <td class="td-70">{{ total.category }}</td>
                                    </tr>
                                    <tr>
                                        <td class="td-30">Total Transaction of the month: </td>
                                        <td class="td-70">{{ total.transaction_thismo }}</td>
                                    </tr>
                                    <tr>
                                        <td class="td-30">Total Overall transaction: </td>
                                        <td class="td-70">{{ total.transaction }}</td>
                                    </tr>
                                    <tr>
                                        <td class="td-30">Total products sold: </td>
