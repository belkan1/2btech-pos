                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tr v-for="order_detail in data_order.details" v-bind:key="order_detail.id">
                                                                        ...
                                                                        <td class="text-center">Rs {{ numberFormat(order_detail.price - order_detail.ppn) }}</td>
                                                                        <td class="text-center">{{ order_detail.quantity }}</td>
                                                                        <td class="text-right">Rs {{ numberFormat(order_detail.subtotal - order_detail.ppn*order_detail.quantity)}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="no-line"></td>
                                                                        <td class="no-line"></td>
                                                                        ...
                                                                        <td class="no-line text-right">Rs {{  numberFormat(totalPPN) }} </span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="thick-line text-right">Rs {{numberFormat(data_order.total)}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="no-line"></td>
                                                                        <td class="no-line"></td>
