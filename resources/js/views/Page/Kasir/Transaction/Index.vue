        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">Transaction</h4>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" autocomplete="off" placeholder="Search for the product code or name" id="kode-produk" v-model="search" @keyup="searchProduct()">
                            ...
                            <table class="table table-striped" id="table-transaction">
                                ...
                                <tbody>
                                    <tr v-for="(product,index) in cart" :key="product.id">
                                        ...
                                        <td>
                                            <input type="number" class="form-control" @click="changeQuantity(index)" v-model="qty[index]" value="1">
                                        </td>
                                        <td>
                                            {{ product.stock }}
                                        </td>
                                        <td>
                                            Rs {{ formatPrice(product.realPrice) }} <span class='text-success' v-if="product.discount !== null">Discount!</span>
                                        </td>
                                        <td>
...
export default {
    ...
    methods: {
        ...
        countTotalPrice() {
            ...
            this.kembalian = this.kembalian-totalPrice;
        ...
        showKeteranganModal() {
			if(this.bayar < this.totalPrice) {
				this.error = `Minimum amount is Rs ${this.totalPrice}`;
				return;
            }
